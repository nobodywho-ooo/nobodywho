 ...
 * completion, streaming and tool calling — and renders the outcome. The Detox
 * suite in `e2e/` waits for that outcome, so the assertions live here where
 * they can use the library's own API.
 */
