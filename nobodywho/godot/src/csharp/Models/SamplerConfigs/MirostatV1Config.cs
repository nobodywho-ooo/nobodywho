...
/// <summary>
/// The method config values for the <see cref="SamplerMethod.MirostatV1"/> sampler method.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class MirostatV1Config : IMethodConfig
{
    private readonly Resource _samplerResource;

    /// <summary>
    /// Constructs a new instance of the <see cref="MirostatV1Config"/>.
    /// </summary>
    /// <param name="resource">The actual sampler resource from the GDExtension.</param>
    public MirostatV1Config(Resource resource)
    {
    ...
    /// <inheritdoc/>
    public SamplerMethod Method => SamplerMethod.MirostatV1;
