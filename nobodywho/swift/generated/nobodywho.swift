...
open class CrossEncoder: CrossEncoderProtocol, @unchecked Sendable {
     ...
     */
public convenience init(model: Model, contextSize: UInt32?) {
    let handle =
        try! rustCall() {
    uniffi_nobodywho_uniffi_fn_constructor_crossencoder_new(
...
public convenience init(model: Model, contextSize: UInt32?) {
    let handle =
        try! rustCall() {
    uniffi_nobodywho_uniffi_fn_constructor_encoder_new(
        FfiConverterTypeModel_lower(model),
        FfiConverterOptionUInt32.lower(contextSize),$0
    )
}
...
open class RustChat: RustChatProtocol, @unchecked Sendable {
     ...
     */
public convenience init(model: Model, systemPrompt: String?, contextSize: UInt32, templateVariables: [String: Bool]?, tools: [RustTool]?, sampler: SamplerConfig?) {
    let handle =
        try! rustCall() {
 ...
 */
public func loadModel(modelPath: String, useGpu: Bool, imageModelPath: String?)async throws  -> Model  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_nobodywho_uniffi_fn_func_load_model(FfiConverterString.lower(modelPath),FfiConverterBool.lower(useGpu),FfiConverterOptionString.lower(imageModelPath)
                )
            },
            ...
            liftFunc: FfiConverterTypeModel_lift,
            errorHandler: FfiConverterTypeNobodyWhoError_lift
        )
}
/**
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_nobodywho_uniffi_checksum_func_load_model() != 19243) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nobodywho_uniffi_checksum_func_sampler_preset_json() != 40006) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nobodywho_uniffi_checksum_method_crossencoder_rank() != 14399) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nobodywho_uniffi_checksum_method_crossencoder_rank_and_sort_json() != 4173) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nobodywho_uniffi_checksum_method_encoder_encode() != 21765) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nobodywho_uniffi_checksum_method_samplerbuilder_grammar() != 24369) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_nobodywho_uniffi_checksum_constructor_crossencoder_new() != 12491) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nobodywho_uniffi_checksum_constructor_encoder_new() != 32094) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nobodywho_uniffi_checksum_constructor_rustchat_new() != 6355) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_nobodywho_uniffi_checksum_constructor_rusttool_new() != 54104) {
        return InitializationResult.apiChecksumMismatch
    }
