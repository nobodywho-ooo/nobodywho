    ...
    crates = {
      ...
      "llama-cpp-2" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "2c94e3655c04e182fe30dac101ef870a31e59598";
          sha256 = "0bk60d4cs31xhkd4b2aw6bdx2ahrxrz4lwpa8gzcrwy49g6md9d6";
        };
        libName = "llama_cpp_2";
        dependencies = [
          {
      ...
      "nobodywho-server" = rec {
        crateName = "nobodywho-server";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
            name = "nobodywho-server";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
      ...
      "nobodywho-uniffi" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "oslog";
            packageId = "oslog";
            target = { target, features }: (("apple" == target."vendor" or null) && (!("macos" == target."os" or null)));
          }
          {
            name = "serde_json";
            packageId = "serde_json";
