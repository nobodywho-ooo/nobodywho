    ...
    crates = {
      ...
      "nobodywho" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "dirs";
            packageId = "dirs";
            target = { target, features }: ((!("android" == target."os" or null)) && (!(builtins.elem "wasm" target."family")));
          }
          {
            name = "encoding_rs";
            packageId = "encoding_rs";
      ...
      "pyo3" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "3a7c0f0645fa4c8450f89515670b70b88799de88";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "handleapi" "processenv" "winbase" "wincon" "winnt" ];
      };
