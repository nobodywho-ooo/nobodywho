  ...
  internal = rec {
    ...
    crates = {
      ...
      "hf-hub" = rec {
        ...
        version = "0.5.0";
        edition = "2021";
        sha256 = "04x2wsz3wf4vyxxfxavc197jzwpia5gk06zibwczm3lp70k9iwxf";
        libName = "hf_hub";
        dependencies = [
          {
            name = "dirs";
      ...
      "llama-cpp-2" = rec {
        ...
        version = "0.1.141";
        edition = "2021";
        sha256 = "1cbgl0kfkap906b9w4r7fyy2c0nfcji55lqpcslal042f5iqc5hy";
        libName = "llama_cpp_2";
        dependencies = [
          {
            name = "encoding_rs";
      ...
      "llama-cpp-sys-2" = rec {
        ...
        edition = "2021";
        links = "llama";
        sha256 = "07nw159xcdi75jsv4rrvh5przixg0qg5ywjxa1brkhwscv4f49pc";
      ...
      "minijinja" = rec {
        ...
        version = "2.18.0";
        edition = "2021";
        sha256 = "0z9f06zkakxk3910cn4lfzf2f9sh0z18z24qc6z1br6qibjm30ij";
        authors = [
          "Armin Ronacher <armin.ronacher@active-4.com>"
        ];
        dependencies = [
      ...
      "minijinja-contrib" = rec {
        ...
        version = "2.18.0";
        edition = "2021";
        sha256 = "1mw02iqyw47x141l8j5dlb5fak81b9zzys42jzygjl9bgpj04qwc";
      ...
      "ureq" = rec {
        ...
        resolvedDefaultFeatures = [ "_ring" "_rustls" "_tls" "default" "gzip" "json" "rustls" "rustls-no-provider" "rustls-webpki-roots" "socks-proxy" ];
      };
      "ureq-proto" = rec {
