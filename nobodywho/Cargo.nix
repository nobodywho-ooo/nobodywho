  ...
  internal = rec {
    ...
    crates = {
      ...
      "nobodywho" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            features = [ "openmp" "mtmd" "llguidance" "common" "dynamic-link" "dynamic-backends" ];
          }
          {
            name = "llama-cpp-2";
            packageId = "llama-cpp-2";
            ...
            features = [ "openmp" "vulkan" "mtmd" "llguidance" "common" "dynamic-link" "dynamic-backends" ];
          }
          {
            name = "llama-cpp-2";
            packageId = "llama-cpp-2";
            usesDefaultFeatures = false;
            target = { target, features }: ("android" == target."os" or null);
            features = [ "android-static-stdcxx" "dynamic-link" "dynamic-backends" ];
          }
          {
            name = "llama-cpp-sys-2";
            packageId = "llama-cpp-sys-2";
          ...
          }
          {
            ...
            packageId = "ort";
            usesDefaultFeatures = false;
            target = { target, features }: (("linux" == target."os" or null) || ("windows" == target."os" or null));
            features = [ "cuda" ];
          }
          {
            name = "ort";
          ...
          }
          {
            ...
            packageId = "windows-sys 0.61.2";
            target = { target, features }: ("windows" == target."os" or null);
            features = [ "Win32_System_SystemInformation" "Win32_System_LibraryLoader" "Win32_Foundation" ];
          }
        ];
      ...
      "ort-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "__tls" "api-17" "api-18" "api-19" "api-20" "copy-dylibs" "cuda" "download-binaries" "std" "tls-rustls" "tls-rustls-no-provider" ];
      };
      "oslog" = rec {
        crateName = "oslog";
        version = "0.2.0";
