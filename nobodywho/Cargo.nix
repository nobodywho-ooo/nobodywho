...
#
# DO NOT hand-edit. The sha256 entries in `fetchgit` blocks below are
# derived from `crate-hashes.json` — to bump a git dependency, update
# the hash in crate-hashes.json and re-run crate2nix to regenerate
# this whole file. Hand-edited hashes drift from crate-hashes.json
# and the next `crate2nix generate` silently undoes them.
  ...
  internal = rec {
    ...
    crates = {
      ...
      "kqueue-sys" = rec {
        ...
        version = "1.1.0";
        edition = "2021";
        sha256 = "0byssypr815kj1kxbk8sxc70yjmx5ngncbl8z8irz52z85h5idm7";
        libName = "kqueue_sys";
        authors = [
          "William Orr <will@worrbase.com>"
      ...
      "llama-cpp-2" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "5cc30227f0367339d807a5a2b28081677319d778";
          sha256 = "1y4kbhy7g5kk7ak23znbfv6gncb68qwx4zddm1kpg6wfgia8d4j1";
        };
        libName = "llama_cpp_2";
        dependencies = [
          {
