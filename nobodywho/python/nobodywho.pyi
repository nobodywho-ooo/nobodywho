...
class Chat:
    def __new__(cls, /, model: Model | str, n_ctx: int = 4096, system_prompt: str = "", allow_thinking: bool = True, tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> Chat: ...
...
class ChatAsync:
    def __new__(cls, /, model: Model | str, n_ctx: int = 4096, system_prompt: str = "", allow_thinking: bool = True, tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> ChatAsync: ...
...
class CrossEncoder:
    def __new__(cls, /, model: Model | str, n_ctx: int = 4096) -> CrossEncoder: ...
...
class CrossEncoderAsync:
    def __new__(cls, /, model: Model | str, n_ctx: int = 4096) -> CrossEncoderAsync: ...
...
class Encoder:
    def __new__(cls, /, model: Model | str, n_ctx: int = 4096) -> Encoder: ...
    def encode(self, /, text: str) -> list[float]: ...

class EncoderAsync:
    def __new__(cls, /, model: Model | str, n_ctx: int = 4096) -> EncoderAsync: ...
    def encode(self, /, text: str) -> typing.Awaitable[list[float]]: ...

class Model:
    def __new__(cls, /, model_path: str, use_gpu_if_available: bool = True) -> Model: ...
...
def tool(description: str, params: dict[str, str] | None = None) -> typing.Callable[..., Tool]: ...
