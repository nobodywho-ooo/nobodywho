...
class Chat:
    def __new__(cls, /, model: Model | os.PathLike | str, n_ctx: int = 4096, system_prompt: str | None = None, template_variables: dict[str, bool] = ..., tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> Chat: ...
    ...
    def set_template_variable(self, /, key: str, value: bool) -> None: ...
    def set_template_variables(self, /, variables: dict[str, bool]) -> None: ...
    def set_tools(self, /, tools: list[Tool]) -> None: ...
    def stop_generation(self, /) -> None: ...

class ChatAsync:
    def __new__(cls, /, model: Model | os.PathLike | str, n_ctx: int = 4096, system_prompt: str | None = None, template_variables: dict[str, bool] = ..., tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> ChatAsync: ...
    ...
    def set_sampler_config(self, /, sampler: SamplerConfig) -> None: ...
    def set_system_prompt(self, /, system_prompt: str | None) -> None: ...
    def set_template_variable(self, /, key: str, value: bool) -> typing.Awaitable[None]: ...
...
class Model:
    ...
    @staticmethod
    def load_model_async(model_path: os.PathLike | str, use_gpu_if_available: bool = True) -> typing.Awaitable[Model]: ...
