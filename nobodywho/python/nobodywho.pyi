...
class Chat:
    ...
    ) -> "TokenStream | ChatCompletionStream | ChatCompletion":
        """
...
class ChatCompletionStream:
    ...
    def completed(self, /) -> ChatCompletion: ...
...
class ChatCompletionToolCall:
    ...
    def __repr__(self, /) -> str: ...
    @property
    def function(self, /) -> ChatCompletionFunction: ...
    @property
    def id(self, /) -> str: ...
    @property
    def index(self, /) -> int: ...
...
class Response:
    ...
    def id(self, /) -> str: ...
    @property
    def incomplete_details(self, /) -> dict[str, str] | None: ...
    def keys(self, /) -> list[str]: ...
    @property
    def model(self, /) -> str: ...
    def model_dump(self, /) -> "dict": ...
    ...
    def object(self, /) -> str: ...
    @property
    def output(self, /) -> list[ResponseOutputMessage]: ...
    @property
...
class ResponseOutputMessage:
    ...
    def __repr__(self, /) -> str: ...
    @property
    def content(self, /) -> list[ResponseOutputText]: ...
    @property
    def id(self, /) -> str: ...
    def keys(self, /) -> list[str]: ...
    def model_dump(self, /) -> "dict": ...
