...
class Chat:
    def __new__(cls, /, model: Model | str, n_ctx: int = 2048, system_prompt: str = "", allow_thinking: bool = True, tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> Chat: ...
...
class ChatAsync:
    def __new__(cls, /, model: Model | str, n_ctx: int = 2048, system_prompt: str = "", allow_thinking: bool = True, tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> ChatAsync: ...
