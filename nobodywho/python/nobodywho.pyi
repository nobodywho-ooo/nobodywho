...
class Chat:
    def __new__(cls, /, model: Model | os.PathLike | str, n_ctx: int = 4096, system_prompt: str | None = None, allow_thinking: bool = True, tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> Chat: ...
...
class ChatAsync:
    def __new__(cls, /, model: Model | os.PathLike | str, n_ctx: int = 4096, system_prompt: str | None = None, allow_thinking: bool = True, tools: list[Tool] = ..., sampler: SamplerConfig = ...) -> ChatAsync: ...
...
class Model:
    def __new__(cls, /, model_path: os.PathLike | str, use_gpu_if_available: bool = True, mmproj_path: os.PathLike | str | None = None) -> Model: ...
    @staticmethod
    def load_model_async(model_path: os.PathLike | str, use_gpu_if_available: bool = True, mmproj_path: os.PathLike | str | None = None) -> typing.Awaitable[Model]: ...
