...
package com.nobodywhoreactnative

import com.facebook.react.bridge.ReactApplicationContext
import com.facebook.react.module.annotations.ReactModule
import com.facebook.react.turbomodule.core.interfaces.CallInvokerHolder

@ReactModule(name = NobodywhoReactNativeModule.NAME)
class NobodywhoReactNativeModule(reactContext: ReactApplicationContext) :
  NativeNobodywhoReactNativeSpec(reactContext) {
  ...
  companion object {
    const val NAME = "NobodywhoReactNative"

    init {
      System.loadLibrary("nobodywho-react-native")
    }
  }
}