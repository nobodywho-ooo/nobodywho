...
export const PromptPart = (() => {
    ...
    class ImageBytes_ extends UniffiEnum implements ImageBytes__interface {
        ...
        static new(inner: { data: ArrayBuffer }): ImageBytes_ {
    ...
    type AudioPcm__interface = {
        ...
        inner: Readonly<{samples: Array</*i16*/number>; sampleRate: /*u32*/number}>
    };
    ...
    class AudioPcm_ extends UniffiEnum implements AudioPcm__interface {
        ...
        readonly inner: Readonly<{samples: Array</*i16*/number>; sampleRate: /*u32*/number}>;
        constructor(inner: { samples: Array</*i16*/number>, sampleRate: /*u32*/number }) {
            super("PromptPart", "AudioPcm");
            this.inner = Object.freeze(inner);
        }

        static new(inner: { samples: Array</*i16*/number>, sampleRate: /*u32*/number }): AudioPcm_ {
    ...
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            switch (ordinalConverter.read(from)) {
                ...
                case 5: return new PromptPart.AudioPcm({samples: FfiConverterArrayInt16.read(from), sampleRate: FfiConverterUInt32.read(from) });
                default: throw new UniffiInternalError.UnexpectedEnumCase();
            }
        }
        write(value: TypeName, into: RustBuffer): void {
            switch (value.tag) {
                ...
                case PromptPart_Tags.AudioPcm: {
                    ...
                    const inner = value.inner;
                    FfiConverterArrayInt16.write(inner.samples, into);
        ...
        allocationSize(value: TypeName): number {
            switch (value.tag) {
                ...
                case PromptPart_Tags.AudioPcm: {
                    ...
                    size += FfiConverterArrayInt16.allocationSize(inner.samples);
