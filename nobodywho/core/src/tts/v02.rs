use crate::tts::{TtsSpeaker, TtsSpeakerPreset};
...
pub(crate) fn prompt(
    ...
    match &request.speaker {
        ...
        TtsSpeaker::Profile(_) => Err(crate::errors::TtsWorkerError::InvalidRequest(
            "speaker profiles are not supported by the OuteTTS 0.2 backend".into(),
        )),
    }
}

pub(crate) fn build_default_english_male_suffix(processed_text: &str) -> String {
