...
static Future<RustChat>  fromPath({required String modelPath , String? imageIngestion = null, String? systemPrompt = null, int contextSize = 4096, bool? allowThinking = null, Map<String, bool> templateVariables = const {}, List<RustTool> tools = const [], SamplerConfig? sampler = null, bool useGpu = true})=>NobodyWho.instance.api.crateRustChatFromPath(modelPath: modelPath, imageIngestion: imageIngestion, systemPrompt: systemPrompt, contextSize: contextSize, allowThinking: allowThinking, templateVariables: templateVariables, tools: tools, sampler: sampler, useGpu: useGpu);
...
///     tools: List of Tool instances the model can call
///     sampler: SamplerConfig for token selection. Pass null to use default sampler.
factory RustChat({required Model model , String? systemPrompt = null, int contextSize = 4096, bool? allowThinking = null, Map<String, bool> templateVariables = const {}, List<RustTool> tools = const [], SamplerConfig? sampler = null})=>NobodyWho.instance.api.crateRustChatNew(model: model, systemPrompt: systemPrompt, contextSize: contextSize, allowThinking: allowThinking, templateVariables: templateVariables, tools: tools, sampler: sampler);
