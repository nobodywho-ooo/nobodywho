...
class NobodyWho
  ...
  @override
  int get rustContentHash => -340331037;
...
abstract class NobodyWhoApi extends BaseApi {
  ...
  String crateModelSource({required Model that});
  ...
  RustTokenStream crateRustChatAskWithJsonPrompt({
    required RustChat that,
  ...
  Future<void> crateRustChatSetContextShift({
    required RustChat that,
    required ContextShiftOptions options,
  });
  ...
  Future<List<int?>> crateRustChatTokenize({
    required RustChat that,
    required String message,
  });

  Future<List<int?>> crateRustChatTokenizeWithPrompt({
    required RustChat that,
    required List<ContentPart> parts,
  });
  ...
  SamplerBuilder crateSamplerBuilderConstrainWithGrammar({
    required SamplerBuilder that,
    required String grammar,
  });

  SamplerBuilder crateSamplerBuilderConstrainWithJsonSchema({
    required SamplerBuilder that,
    required String schema,
  });

  SamplerBuilder crateSamplerBuilderConstrainWithRegex({
    required SamplerBuilder that,
  ...
  SamplerBuilder crateSamplerBuilderDynamicTemperature({
    required SamplerBuilder that,
  ...
  SamplerBuilder crateSamplerBuilderJson({required SamplerBuilder that});

  SamplerBuilder crateSamplerBuilderLogitBias({
    required SamplerBuilder that,
    required Map<int, double> biases,
  });
  ...
  SamplerBuilder crateSamplerBuilderSeed({
    required SamplerBuilder that,
    required int seed,
  });
  ...
  SamplerBuilder crateSamplerBuilderTopNSigma({
    required SamplerBuilder that,
    required double n,
  });
  ...
  SamplerConfig crateSamplerPresetsConstrainWithGrammar({
    required String grammar,
  });

  SamplerConfig crateSamplerPresetsConstrainWithJsonSchema({
    required String schema,
  });

  SamplerConfig crateSamplerPresetsConstrainWithRegex({
    required String pattern,
  });
  ...
  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_TokenizeError;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_TokenizeErrorPtr;
}
...
class NobodyWhoApiImpl extends NobodyWhoApiImplPlatform
  ...
  TaskConstMeta get kCrateModelMaxCtxConstMeta =>
      const TaskConstMeta(debugName: "Model_max_ctx", argNames: ["that"]);
  ...
  String crateModelSource({required Model that}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateModelSourceConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateModelSourceConstMeta =>
      const TaskConstMeta(debugName: "Model_source", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateRustChatAskWithJsonPromptConstMeta =>
      const TaskConstMeta(
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_list_content_part(parts, serializer);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_box_autoadd_context_shift_options(
            contextShift,
            serializer,
          );
          pdeCallFfi(
  ...
  TaskConstMeta get kCrateRustChatGetStatsConstMeta =>
      const TaskConstMeta(debugName: "RustChat_get_stats", argNames: ["that"]);
  ...
  TaskConstMeta get kCrateRustChatMtpAcceptanceRateConstMeta =>
      const TaskConstMeta(
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_context_shift_options(options, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 28,
        ...
        constMeta: kCrateRustChatSetContextShiftConstMeta,
  ...
  TaskConstMeta get kCrateRustChatSetContextShiftConstMeta =>
      const TaskConstMeta(
        debugName: "RustChat_set_context_shift",
  ...
  TaskConstMeta get kCrateRustChatTokenizeWithPromptConstMeta =>
      const TaskConstMeta(
  ...
  SamplerBuilder crateSamplerBuilderConstrainWithGrammar({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateSamplerBuilderConstrainWithGrammarConstMeta,
        argValues: [that, grammar],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateSamplerBuilderConstrainWithGrammarConstMeta =>
      const TaskConstMeta(
        debugName: "SamplerBuilder_constrain_with_grammar",
        argNames: ["that", "grammar"],
      );
  ...
  SamplerBuilder crateSamplerBuilderConstrainWithJsonSchema({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateSamplerBuilderConstrainWithJsonSchemaConstMeta,
  ...
  TaskConstMeta get kCrateSamplerBuilderConstrainWithJsonSchemaConstMeta =>
      const TaskConstMeta(
        debugName: "SamplerBuilder_constrain_with_json_schema",
  ...
  SamplerBuilder crateSamplerBuilderConstrainWithRegex({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateSamplerBuilderConstrainWithRegexConstMeta,
  ...
  TaskConstMeta get kCrateSamplerBuilderConstrainWithRegexConstMeta =>
      const TaskConstMeta(
        debugName: "SamplerBuilder_constrain_with_regex",
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_f_32(exponent, serializer);
        ...
        constMeta: kCrateSamplerBuilderDynamicTemperatureConstMeta,
        argValues: [that, temperature, delta, exponent],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateSamplerBuilderDynamicTemperatureConstMeta =>
      const TaskConstMeta(
        debugName: "SamplerBuilder_dynamic_temperature",
        argNames: ["that", "temperature", "delta", "exponent"],
      );
  ...
  SamplerBuilder crateSamplerBuilderJson({required SamplerBuilder that}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateSamplerBuilderJsonConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSamplerBuilderJsonConstMeta =>
      const TaskConstMeta(debugName: "SamplerBuilder_json", argNames: ["that"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_Map_i_32_f_32_None(biases, serializer);
        ...
        constMeta: kCrateSamplerBuilderLogitBiasConstMeta,
        argValues: [that, biases],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateSamplerBuilderLogitBiasConstMeta =>
      const TaskConstMeta(
        debugName: "SamplerBuilder_logit_bias",
        argNames: ["that", "biases"],
      );
  ...
  SamplerBuilder crateSamplerBuilderTopNSigma({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateSamplerBuilderTopNSigmaConstMeta,
        argValues: [that, n],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateSamplerBuilderTopNSigmaConstMeta =>
      const TaskConstMeta(
        debugName: "SamplerBuilder_top_n_sigma",
        argNames: ["that", "n"],
      );
  ...
  TaskConstMeta get kCrateSamplerPresetsConstrainWithGrammarConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateSamplerPresetsConstrainWithJsonSchemaConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateSamplerPresetsConstrainWithRegexConstMeta =>
      const TaskConstMeta(
  ...
  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_TokenizeError => wire
  ...
  @protected
  ContextShiftOptions dco_decode_box_autoadd_context_shift_options(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_context_shift_options(raw);
  }
  ...
  ShiftTarget dco_decode_box_autoadd_shift_target(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_shift_target(raw);
  }
  ...
  ContentPart dco_decode_content_part(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 1:
        return ContentPart_Image(path: dco_decode_String(raw[1]));
      case 2:
        return ContentPart_Audio(path: dco_decode_String(raw[1]));
      default:
  ...
  ContextShiftOptions dco_decode_context_shift_options(dynamic raw) {
    ...
    return ContextShiftOptions(
      ...
      keepFirstTurns: dco_decode_u_32(arr[1]),
      keepLastTurns: dco_decode_u_32(arr[2]),
      target: dco_decode_opt_box_autoadd_shift_target(arr[3]),
    );
  }
  ...
  List<Int16List> dco_decode_list_list_prim_i_16_strict(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_list_prim_i_16_strict)
        .toList();
  }
  ...
  Message dco_decode_message(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return Message_User(
          content: dco_decode_box_autoadd_message_content(raw[1]),
        );
      case 1:
        return Message_Assistant(
          content: dco_decode_box_autoadd_message_content(raw[1]),
          toolCalls: dco_decode_opt_list_tool_call(raw[2]),
        );
      case 2:
      ...
      case 3:
        return Message_Tool(
          ...
          content: dco_decode_box_autoadd_message_content(raw[2]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  MessageContent dco_decode_message_content(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return MessageContent_Text(text: dco_decode_String(raw[1]));
      case 1:
        return MessageContent_Parts(
          parts: dco_decode_list_content_part(raw[1]),
        );
      case 2:
        return MessageContent_Json(json: dco_decode_String(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  ContextShiftOptions? dco_decode_opt_box_autoadd_context_shift_options(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_context_shift_options(raw);
  }
  ...
  ShiftTarget? dco_decode_opt_box_autoadd_shift_target(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_shift_target(raw);
  }
  ...
  (int, double) dco_decode_record_i_32_f_32(dynamic raw) {
    ...
    return (dco_decode_i_32(arr[0]), dco_decode_f_32(arr[1]));
  }
  ...
  ShiftTarget dco_decode_shift_target(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return ShiftTarget_Fraction(dco_decode_f_32(raw[1]));
      case 1:
        return ShiftTarget_Tokens(dco_decode_u_32(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  ToolCall dco_decode_tool_call(dynamic raw) {
    ...
    return ToolCall(
      ...
      arguments: dco_decode_SerdeJsonValue(arr[1]),
    );
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerTokenizeError(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return TokenizeErrorImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  ContextShiftOptions sse_decode_box_autoadd_context_shift_options(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_context_shift_options(deserializer));
  }
  ...
  @protected
  ShiftTarget sse_decode_box_autoadd_shift_target(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_shift_target(deserializer));
  }
  ...
  ContentPart sse_decode_content_part(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return ContentPart_Image(path: var_path);
      case 2:
        var var_path = sse_decode_String(deserializer);
        return ContentPart_Audio(path: var_path);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  ContextShiftOptions sse_decode_context_shift_options(
    ...
    var var_keepFirstTurns = sse_decode_u_32(deserializer);
    var var_keepLastTurns = sse_decode_u_32(deserializer);
    var var_target = sse_decode_opt_box_autoadd_shift_target(deserializer);
    return ContextShiftOptions(
      enabled: var_enabled,
      keepFirstTurns: var_keepFirstTurns,
      keepLastTurns: var_keepLastTurns,
      target: var_target,
    );
  }
  ...
  List<Int16List> sse_decode_list_list_prim_i_16_strict(
    ...
    var ans_ = <Int16List>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_list_prim_i_16_strict(deserializer));
    }
    return ans_;
  }
  ...
  Message sse_decode_message(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_content = sse_decode_box_autoadd_message_content(deserializer);
        return Message_User(content: var_content);
      case 1:
        var var_content = sse_decode_box_autoadd_message_content(deserializer);
  ...
  MessageContent sse_decode_message_content(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_text = sse_decode_String(deserializer);
        return MessageContent_Text(text: var_text);
      case 1:
        var var_parts = sse_decode_list_content_part(deserializer);
        return MessageContent_Parts(parts: var_parts);
      case 2:
        var var_json = sse_decode_String(deserializer);
        return MessageContent_Json(json: var_json);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  ContextShiftOptions? sse_decode_opt_box_autoadd_context_shift_options(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_context_shift_options(deserializer));
    } else {
      return null;
    }
  }
  ...
  ShiftTarget? sse_decode_opt_box_autoadd_shift_target(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_shift_target(deserializer));
    } else {
      return null;
    }
  }
  ...
  ShiftTarget sse_decode_shift_target(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        return ShiftTarget_Fraction(var_field0);
      case 1:
        var var_field0 = sse_decode_u_32(deserializer);
        return ShiftTarget_Tokens(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  ToolCall sse_decode_tool_call(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_name = sse_decode_String(deserializer);
    var var_arguments = sse_decode_SerdeJsonValue(deserializer);
    return ToolCall(name: var_name, arguments: var_arguments);
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerTokenizeError(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as TokenizeErrorImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerTokenizeError(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as TokenizeErrorImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_SerdeJsonValue(Object? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(jsonEncode(self), serializer);
  }
  ...
  void sse_encode_box_autoadd_context_shift_options(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_context_shift_options(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_shift_target(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_shift_target(self, serializer);
  }
  ...
  void sse_encode_content_part(ContentPart self, SseSerializer serializer) {
    ...
    switch (self) {
      case ContentPart_Text(text: final text):
        ...
        sse_encode_String(text, serializer);
      case ContentPart_Image(path: final path):
        sse_encode_i_32(1, serializer);
        sse_encode_String(path, serializer);
      case ContentPart_Audio(path: final path):
  ...
  void sse_encode_context_shift_options(
    ...
    sse_encode_u_32(self.keepFirstTurns, serializer);
    sse_encode_u_32(self.keepLastTurns, serializer);
    sse_encode_opt_box_autoadd_shift_target(self.target, serializer);
  }
  ...
  void sse_encode_list_list_prim_i_16_strict(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_list_prim_i_16_strict(item, serializer);
    }
  }
  ...
  void sse_encode_message(Message self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case Message_User(content: final content):
        sse_encode_i_32(0, serializer);
        sse_encode_box_autoadd_message_content(content, serializer);
      case Message_Assistant(
        ...
        sse_encode_i_32(1, serializer);
        sse_encode_box_autoadd_message_content(content, serializer);
        sse_encode_opt_list_tool_call(toolCalls, serializer);
  ...
  void sse_encode_message_content(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case MessageContent_Text(text: final text):
        sse_encode_i_32(0, serializer);
        sse_encode_String(text, serializer);
      case MessageContent_Parts(parts: final parts):
        sse_encode_i_32(1, serializer);
        sse_encode_list_content_part(parts, serializer);
      case MessageContent_Json(json: final json):
        sse_encode_i_32(2, serializer);
        sse_encode_String(json, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_context_shift_options(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_context_shift_options(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_shift_target(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_shift_target(self, serializer);
    }
  }
  ...
  void sse_encode_shift_target(ShiftTarget self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case ShiftTarget_Fraction(field0: final field0):
        sse_encode_i_32(0, serializer);
        sse_encode_f_32(field0, serializer);
      case ShiftTarget_Tokens(field0: final field0):
        sse_encode_i_32(1, serializer);
  ...
  void sse_encode_tool_call(ToolCall self, SseSerializer serializer) {
    ...
    sse_encode_SerdeJsonValue(self.arguments, serializer);
  }
...
class ModelImpl extends RustOpaque implements Model {
  ...
  String get source => NobodyWho.instance.api.crateModelSource(that: this);
}
...
class RustChatImpl extends RustOpaque implements RustChat {
  ...
  RustTokenStream askWithJsonPrompt({required String json}) => NobodyWho
      .instance
      .api
      .crateRustChatAskWithJsonPrompt(that: this, json: json);
  ...
  RustTokenStream askWithPrompt({required List<ContentPart> parts}) => NobodyWho
      .instance
      .api
  ...
  Future<ChatStats> getStats() =>
      NobodyWho.instance.api.crateRustChatGetStats(that: this);
  ...
  Future<double?> mtpAcceptanceRate() =>
      NobodyWho.instance.api.crateRustChatMtpAcceptanceRate(that: this);
  ...
  Future<void> setContextShift({required ContextShiftOptions options}) =>
      NobodyWho.instance.api.crateRustChatSetContextShift(
        that: this,
        options: options,
      );
  ...
  Future<List<int?>> tokenize({required String message}) => NobodyWho
      .instance
      .api
      .crateRustChatTokenize(that: this, message: message);

  Future<List<int?>> tokenizeWithPrompt({required List<ContentPart> parts}) =>
      NobodyWho.instance.api.crateRustChatTokenizeWithPrompt(
        that: this,
        parts: parts,
      );
}
...
class SamplerBuilderImpl extends RustOpaque implements SamplerBuilder {
  ...
  SamplerBuilder constrainWithGrammar({required String grammar}) => NobodyWho
      .instance
      .api
      .crateSamplerBuilderConstrainWithGrammar(that: this, grammar: grammar);
  ...
  SamplerBuilder constrainWithJsonSchema({required String schema}) => NobodyWho
      .instance
      .api
      .crateSamplerBuilderConstrainWithJsonSchema(that: this, schema: schema);

  /// Constrain output to a regular expression.
  SamplerBuilder constrainWithRegex({required String pattern}) => NobodyWho
      .instance
      .api
      .crateSamplerBuilderConstrainWithRegex(that: this, pattern: pattern);
  ...
  SamplerBuilder dynamicTemperature({
    ...
    required double delta,
    required double exponent,
  }) => NobodyWho.instance.api.crateSamplerBuilderDynamicTemperature(
    that: this,
  ...
  SamplerBuilder logitBias({required Map<int, double> biases}) => NobodyWho
      .instance
      .api
      .crateSamplerBuilderLogitBias(that: this, biases: biases);
  ...
  SamplerBuilder seed({required int seed}) =>
      NobodyWho.instance.api.crateSamplerBuilderSeed(that: this, seed: seed);
  ...
  SamplerBuilder topNSigma({required double n}) =>
      NobodyWho.instance.api.crateSamplerBuilderTopNSigma(that: this, n: n);
...
class TokenizeErrorImpl extends RustOpaque implements TokenizeError {
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        NobodyWho.instance.api.rust_arc_increment_strong_count_TokenizeError,
    rustArcDecrementStrongCount:
        NobodyWho.instance.api.rust_arc_decrement_strong_count_TokenizeError,
    rustArcDecrementStrongCountPtr:
        NobodyWho.instance.api.rust_arc_decrement_strong_count_TokenizeErrorPtr,
  );
}
