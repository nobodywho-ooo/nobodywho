    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            0 => {
                ...
                let mut var_assetIds = <Vec<String>>::sse_decode(deserializer);
                return crate::Message::Message {
                    role: var_role,
                    content: var_content,
                    asset_ids: var_assetIds,
                };
            }
            1 => {
                let mut var_role = <crate::Role>::sse_decode(deserializer);
    ...
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self.0 {
            crate::Message::Message {
                ...
                asset_ids.into_into_dart().into_dart(),
            ]
            .into_dart(),
            crate::Message::ToolCalls {
                role,
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::Message::Message {
                ...
                <Vec<String>>::sse_encode(asset_ids, serializer);
            }
            crate::Message::ToolCalls {
                role,
                content,
