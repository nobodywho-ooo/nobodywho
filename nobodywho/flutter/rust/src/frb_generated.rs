...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        34 => wire__crate__RustSpeechToTextStream_completed_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__RustSpeechToTextStream_iter_impl(port, ptr, rust_vec_len, data_len),
        36 => {
        ...
        77 => wire__crate__TextToSpeech_load_impl(port, ptr, rust_vec_len, data_len),
        78 => wire__crate__TextToSpeech_synthesize_impl(port, ptr, rust_vec_len, data_len),
        84 => wire__crate__download_model_impl(port, ptr, rust_vec_len, data_len),
        86 => wire__crate__init_app_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        53 => wire__crate__SamplerBuilder_min_p_impl(ptr, rust_vec_len, data_len),
        54 => wire__crate__SamplerBuilder_mirostat_v1_impl(ptr, rust_vec_len, data_len),
        55 => wire__crate__SamplerBuilder_mirostat_v2_impl(ptr, rust_vec_len, data_len),
        56 => wire__crate__SamplerBuilder_new_impl(ptr, rust_vec_len, data_len),
        57 => wire__crate__SamplerBuilder_penalties_impl(ptr, rust_vec_len, data_len),
        58 => wire__crate__SamplerBuilder_seed_impl(ptr, rust_vec_len, data_len),
        59 => wire__crate__SamplerBuilder_temperature_impl(ptr, rust_vec_len, data_len),
        60 => wire__crate__SamplerBuilder_top_k_impl(ptr, rust_vec_len, data_len),
        61 => wire__crate__SamplerBuilder_top_p_impl(ptr, rust_vec_len, data_len),
        62 => wire__crate__SamplerBuilder_typical_p_impl(ptr, rust_vec_len, data_len),
        63 => wire__crate__SamplerBuilder_xtc_impl(ptr, rust_vec_len, data_len),
        64 => wire__crate__SamplerConfig_from_json_impl(ptr, rust_vec_len, data_len),
        65 => wire__crate__SamplerConfig_to_json_impl(ptr, rust_vec_len, data_len),
        66 => wire__crate__SamplerPresets_constrain_with_grammar_impl(ptr, rust_vec_len, data_len),
        67 => {
            wire__crate__SamplerPresets_constrain_with_json_schema_impl(ptr, rust_vec_len, data_len)
        }
        68 => wire__crate__SamplerPresets_constrain_with_regex_impl(ptr, rust_vec_len, data_len),
        69 => wire__crate__SamplerPresets_default_sampler_impl(ptr, rust_vec_len, data_len),
        70 => wire__crate__SamplerPresets_dry_impl(ptr, rust_vec_len, data_len),
        71 => wire__crate__SamplerPresets_grammar_impl(ptr, rust_vec_len, data_len),
        72 => wire__crate__SamplerPresets_greedy_impl(ptr, rust_vec_len, data_len),
        73 => wire__crate__SamplerPresets_json_impl(ptr, rust_vec_len, data_len),
        74 => wire__crate__SamplerPresets_temperature_impl(ptr, rust_vec_len, data_len),
        75 => wire__crate__SamplerPresets_top_k_impl(ptr, rust_vec_len, data_len),
        76 => wire__crate__SamplerPresets_top_p_impl(ptr, rust_vec_len, data_len),
        79 => wire__crate__ToolCall_auto_accessor_get_arguments_impl(ptr, rust_vec_len, data_len),
        80 => wire__crate__ToolCall_auto_accessor_get_name_impl(ptr, rust_vec_len, data_len),
        81 => wire__crate__ToolCall_auto_accessor_set_arguments_impl(ptr, rust_vec_len, data_len),
        82 => wire__crate__ToolCall_auto_accessor_set_name_impl(ptr, rust_vec_len, data_len),
        83 => wire__crate__cosine_similarity_impl(ptr, rust_vec_len, data_len),
        85 => wire__crate__get_cached_models_impl(ptr, rust_vec_len, data_len),
        87 => wire__crate__new_bash_tool_impl(ptr, rust_vec_len, data_len),
        88 => wire__crate__new_python_tool_impl(ptr, rust_vec_len, data_len),
        89 => wire__crate__new_tool_impl_impl(ptr, rust_vec_len, data_len),
        90 => wire__crate__noop_on_download_progress_impl(ptr, rust_vec_len, data_len),
        91 => wire__crate__tool_call_arguments_json_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
