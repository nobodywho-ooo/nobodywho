...
NobodyWho supports the main Chat Completions flow with `model`, a full `messages` list, one returned choice, usage, local tools, `temperature`, `top_p`, `seed`, and optional streaming.
