...
To define one, pass the function to Tool() with a name and description.
To get a good sense of how such a tool can look like, consider this geometry example:
