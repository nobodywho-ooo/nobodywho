...
```swift
let stt = try SpeechToText(source: "hf://onnx-community/whisper-base", quantization: "q4")
```
...
```swift
let stt = try SpeechToText(source: "hf://onnx-community/whisper-base", language: "en")
```
