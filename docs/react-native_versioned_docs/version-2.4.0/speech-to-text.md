...
To transcribe audio into text (also known as automatic speech recognition, or ASR), NobodyWho provides an integration with the Whisper models in ONNX format.
